...
public class CheckStatus {
  ...
  public void testCheckStatus() {
	 ...
	 // this.iewb.findElement(By.xpath("//a[text() = 'Check Status']")).click();
	  this.iewb.findElement(By.id("checkcardstatus")).click();
      String Value = this.iewb.findElement(By.className("infoTable")).getText();//获取字符串
	  String expected = "Status: AC";//预期结果
	  System.out.println("------------------" + Value.substring(5,15));
	  assertEquals(expected, Value.substring(5,15));//截取字符串，断言
