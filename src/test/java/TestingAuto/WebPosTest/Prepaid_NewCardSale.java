...
public class Prepaid_NewCardSale {
...
//	String terminalName = "test311999999"; //终端名字
  ...
  public void testNewCardSale(){
	...
	//  action.click(iewb.findElement(By.linkText("Type card number")));
      ...
      String expected = "Approved - This card has been activated.";
      assertEquals(expected, Value);
      this.iewb.findElement(By.linkText("Done")).click();
      this.logout();
}
 @Test
  public void testNewCardSaleAlreadyActivated(){
	  this.iewb.manage().timeouts().implicitlyWait(8, TimeUnit.SECONDS);
	  this.iewb.manage().timeouts().pageLoadTimeout(8, TimeUnit.SECONDS);
	  this.login(userName, passWord);
	  this.iewb.findElement(By.id("btn_prepaid")).click();
      ...
      String expected = "Already Activated Card";
